...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Achetez vos fournitures électroniques et bénéficiez de services d'installation, maintenance et dépannage à Goma. Paiement Mobile Money." },
      { name: "author", content: "CONETEC" },
      { property: "og:title", content: "CONETEC — Company of New Technology" },
      { property: "og:description", content: "E-commerce & services électroniques à Goma, RDC. Paiement Mobile Money." },
