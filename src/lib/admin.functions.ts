...
const settingsInput = z.object({
  ...
  instagram_url: z.string().trim().max(300).optional().or(z.literal("")).nullable(),
  linkedin_url: z.string().trim().max(300).optional().or(z.literal("")).nullable(),
  tiktok_url: z.string().trim().max(300).optional().or(z.literal("")).nullable(),
  youtube_url: z.string().trim().max(300).optional().or(z.literal("")).nullable(),
  twitter_url: z.string().trim().max(300).optional().or(z.literal("")).nullable(),
  website_url: z.string().trim().max(300).optional().or(z.literal("")).nullable(),
  maps_url: z.string().trim().max(500).optional().or(z.literal("")).nullable(),
